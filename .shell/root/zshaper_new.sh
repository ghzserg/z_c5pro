...
if [ ${AD5X} -eq 1 ] || [ ${AD5M} -eq 1 ]; then
    ...
    cp "/tmp/resonances_${b_low}_$1.csv" $1
fi
python3 /usr/data/zmod/zmod/.shell/root/zshaper/calibrate_shaper.py $1 --scv=$SCV -o resonances_$1.png -w 8 -l 4.8 --send $1 --${ZLANG} ${ADD}
